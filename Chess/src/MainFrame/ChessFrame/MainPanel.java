			...
			while(true) 
			{
				...
				if(Box!=null) 
				{
					...
					if(players_turn==1)
					{
						...
						if(P2.see_king_Check(P1))// if  king will be in check if moved can't move and will return back to old postion
						{
							P2.checkKing(true);
							if(P2.Check_Mate_GameOver(P1)) 
							{
					...
					else 
					{
						...
						P1.checkKing(false);
						if(P1.see_king_Check(P2))// if  king will be in check if moved can't move and will return back to old postion
						{
							P1.checkKing(true);
							if(P1.Check_Mate_GameOver(P2))
							{
